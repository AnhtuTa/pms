...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`comments_AFTER_INSERT` AFTER INSERT ON `comments` FOR EACH ROW
BEGIN
	update posts set num_of_comments = num_of_comments + 1 where id = new.post_id;
    update posts set newest_comment_time = now() where id = new.post_id;
    
    set @cmt_user1 = (select cmt_user1 from posts where id = new.post_id);
    if @cmt_user1 is null || @cmt_user1 != new.user_id then -- Thực ra ko cần new. cũng đc!
		begin
            UPDATE `posts` SET `cmt_user3`=cmt_user2, `cmt_user2`=cmt_user1, `cmt_user1`=new.user_id WHERE `id` = new.post_id;
		end;
    end if;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`comments_AFTER_DELETE` AFTER DELETE ON `comments` FOR EACH ROW
BEGIN
	update posts set num_of_comments = num_of_comments - 1 where id = old.post_id;
    set @newest_cmt_time = (SELECT time FROM id3217876_project3.comments
							where post_id = 14
							order by time desc
							limit 1);
	if @newest_cmt_time is not null then
		update posts set newest_comment_time = @newest_cmt_time where id = old.post_id;
	end if;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
INSERT INTO `count_posts` VALUES (34);
...
CREATE TABLE `posts` (
  ...
  `newest_comment_time` datetime DEFAULT NULL COMMENT 'Thời gian comment mới nhất',
  `cmt_user1` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ngườ gần nhất comment ở bài post này',
  `cmt_user2` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ngườ gần thứ 2 comment ở bài post này',
  `cmt_user3` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'ngườ gần thứ 3 comment ở bài post này',
  PRIMARY KEY (`id`),
...
INSERT INTO `posts` VALUES (1,'anhtu','Đây là bài post đầu tiên! Welcome my forum!','2017-12-12 16:05:00','first_post,',3,NULL,NULL,NULL,NULL),(2,'anhtu','Đây là bài demo nhé','2017-12-12 18:19:00','demo,',0,NULL,NULL,NULL,NULL),(11,'anhtu','Tìm hiểu về .NET: .NET Framework là nền tảng để chạy các ứng dụng viết = NNLT của Microsoft, hay gọi là môi trường lập trình, môi trường phát triển ƯD','2017-12-12 23:00:12','.NET,',6,NULL,NULL,NULL,NULL),(14,'anhtu','Cuối cùng cũng code xong phần đăng bài. Mệt vãi, phải làm cả JS, CSS nữa!','2017-12-14 18:03:13','first_post,',7,NULL,NULL,NULL,NULL),(15,'anhtu','hehehe, this is a demo!','2017-12-14 22:59:58',NULL,16,NULL,NULL,NULL,NULL),(22,'toan','Hôm nay là T6, ngon roài :)','2017-12-15 11:00:03',NULL,4,NULL,NULL,NULL,NULL),(23,'anhtu','fewa fewafewa ewa','2017-12-15 14:38:23',NULL,6,NULL,NULL,NULL,NULL),(24,'anhtu','ijiok koplo lp,,','2017-12-15 15:23:24',NULL,22,NULL,NULL,NULL,NULL),(25,'anhtu','Đang làm phần phân chia trang cho các bài đăng!','2017-12-16 00:37:27',NULL,21,NULL,NULL,NULL,NULL),(26,'anhtu','This is a post to ask everyone in our lab','2017-12-22 17:54:22',NULL,14,NULL,NULL,NULL,NULL),(27,'admin','Demo post','2017-12-22 17:57:10',NULL,9,NULL,NULL,NULL,NULL),(28,'anhtu','This is a place where you can ask everyone in lab!!','2017-12-22 22:51:48',NULL,16,NULL,NULL,NULL,NULL),(29,'admin','Hôm nay 29/12/2017, chỉ còn 2 ngày nữa là hết năm roài!!!','2017-12-29 13:47:23',NULL,16,NULL,NULL,NULL,NULL),(34,'admin','Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!','2017-12-30 15:16:52',NULL,0,NULL,NULL,NULL,NULL),(35,'admin','Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!! Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n <br>\n <br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n <br>\n Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!! Gần xong cái website này roài! Đang code nốt phần râu ria cho đẹp và friendly hơn!!!<br>\n <br>\n hay lắm!!!','2017-12-30 15:17:59',NULL,0,NULL,NULL,NULL,NULL),(36,'admin','we\'d like to let you know what we\'re doing to keep your information safe whenever you use Facebook. Your account security is important to us, so our security teams look for and catch problems before they reach your account. If we ever see anything unusual happening, we\'ll let you know.<br />\r\n<br />\r\nwe\'d like to let you know what we\'re doing to keep your information safe whenever you use Facebook. <br />\r\nYour account security is important to us, so our security teams look for and catch problems before they reach your account. <br />\r\nIf we ever see anything unusual happening, we\'ll let you know.<br />\r\n<br />\r\n- Nên dùng AJAX load comment, mỗi lần chỉ load vài cmt thôi<br />\r\n- Giao diện hơi xấu<br />\r\n- chưa có phần ảnh, file<br />\r\n- chưa có phần edit comment, post<br />\r\n- tự động tạo hashtag khi bài post có đoạn #some_thing','2017-12-30 16:00:09',NULL,1,NULL,NULL,NULL,NULL),(37,'admin','This is demo post to test:<br />\r\nnewline<br />\r\n\"double quote\"<br />\r\n\'single quote\'<br />\r\nDoes this OK???','2017-12-30 16:01:31',NULL,8,NULL,NULL,NULL,NULL),(39,'anhtu','demo add post','2017-12-31 13:55:00',NULL,1,NULL,NULL,NULL,NULL),(40,'anhtu','another demo','2017-12-31 13:56:17',NULL,2,NULL,NULL,NULL,NULL),(41,'anhtu','demo3','2017-12-31 13:58:39',NULL,4,NULL,NULL,NULL,NULL),(43,'admin','demo post:<br />\r\n- escape HTML tags as HTML entities?<br />\r\n- convert newline to &lt;br/&gt;<br />\r\n- add slash before single quote','2017-12-31 15:52:27',NULL,6,NULL,NULL,NULL,NULL),(44,'admin','demo post:<br />\r\n- &lt;div&gt;escape HTML tags as HTML entities?&lt;/div&gt;<br />\r\n- convert newline to &lt;br/&gt;<br />\r\n- add slash before single quote<br />\r\n','2017-12-31 15:53:02',NULL,9,NULL,NULL,NULL,NULL),(45,'admin','This post #demo about #hashtag','2018-01-03 11:17:04','demo,hashtag,',0,NULL,NULL,NULL,NULL),(46,'admin','This post #demo about #hashtag_demo.feaw #demo;fl #akf-da_demo fealw  feaw ear','2018-01-03 11:39:21','demo,hashtag_demo,demo,akf-da_demo,',0,NULL,NULL,NULL,NULL),(47,'admin','This post #demo about #hashtag_demo.feaw #demo;fl #akf-da_demo fealw feaw ear #demo','2018-01-03 11:44:01','demo,hashtag_demo,akf-da_demo,',0,NULL,NULL,NULL,NULL),(48,'admin','Another demo about hashtag<br />\r\n#happy_new_year<br />\r\n#2018<br />\r\n#project3','2018-01-03 14:41:19','happy_new_year,2018,project3,',3,'2018-01-11 18:19:01','admin','anhtu','admin'),(49,'admin','Another demo about hashtag<br />\r\n#so_hot #pms #today','2018-01-03 14:47:43','so_hot,pms,today,',0,NULL,NULL,NULL,NULL),(50,'admin','Another demo about hashtag<br />\r\n#happy_new_year #2018 #project3','2018-01-03 14:47:59','happy_new_year,2018,project3,',3,NULL,NULL,NULL,NULL),(51,'admin','demo<br />\r\n#trion_nemesis<br />\r\n#vulcan<br />\r\n#lamborghini','2018-01-03 14:55:58','trion_nemesis,vulcan,lamborghini,',7,'2018-01-11 00:47:01','anhtu','admin',NULL),(52,'admin','demo2<br />\r\n#chevoret<br />\r\n#Honda<br />\r\n#arash','2018-01-03 14:58:13','chevoret,Honda,arash,',14,'2018-01-11 15:33:31','admin','nguyen','anhtu'),(53,'nguyen','Hello 2018','2018-01-11 12:15:58','',0,NULL,NULL,NULL,NULL),(55,'nguyen','demo timezone','2018-01-11 12:23:36','',0,NULL,NULL,NULL,NULL),(56,'admin','this is another demo','2018-01-11 15:11:38','',9,'2018-01-11 19:12:48','admin','anhtu',NULL),(58,'admin','This is a test','2018-01-11 19:13:30','',0,NULL,NULL,NULL,NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`posts_AFTER_INSERT` AFTER INSERT ON `posts` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`posts_AFTER_DELETE` AFTER DELETE ON `posts` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`tasks_AFTER_INSERT` AFTER INSERT ON `tasks` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`tasks_BEFORE_UPDATE` BEFORE UPDATE ON `tasks` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`tasks_AFTER_UPDATE` AFTER UPDATE ON `tasks` FOR EACH ROW 
BEGIN
	UPDATE users SET last_activity = now() WHERE id = NEW.user_id;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`id3217876_root`@`%`*/ /*!50003 TRIGGER `id3217876_project3`.`tasks_AFTER_DELETE` AFTER DELETE ON `tasks` FOR EACH ROW
BEGIN
...
-- Dump completed on 2018-01-11 19:18:22
