...
BEGIN
    ...
    set @newest_cmt_time = (SELECT time FROM project3.comments
							where post_id = 14
							order by time desc
							limit 1);
...
INSERT INTO `count_posts` VALUES (35);
...
-- Dump completed on 2018-01-12  0:31:42
